...
import { useSSRContext, createSSRApp, h as h$1 } from "vue";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1>About Page</h1><a${ssrRenderAttr("href", _ctx.route("/"))}>Back to HomePage</a><!--]-->`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Front/About.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1>Inertia JS Starter</h1><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad commodi corporis dolorem eligendi error impedit iure iusto molestiae nesciunt nostrum!</p><ul><li>Laravel 10</li><li>Tailwind CSS</li><li>Inertia JS SSR</li><li>Ziggy</li></ul><a${ssrRenderAttr("href", _ctx.route("about"))}>About Page</a><!--]-->`);
}
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => {
      const pages = /* @__PURE__ */ Object.assign({ "./Pages/Front/About.vue": __vite_glob_0_0, "./Pages/Front/Index.vue": __vite_glob_0_1 });
      return pages[`./Pages/${name}.vue`];
    },
    setup({ App, props, plugin }) {
      return createSSRApp({ render: () => h$1(App, props) }).use(plugin).use(A, Ziggy$1);
    }
  })
  //port
  // 3001
